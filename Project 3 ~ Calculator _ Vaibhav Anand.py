...
#making a window for my calculator

root = Tk()
root.title('Vaibhav Anand - Calculator')
...
display = Entry(root, font=("Calibri",50))
...
#adjusting the sizes of columns and rows according to the size of the calculator widget when minimised or maximised
